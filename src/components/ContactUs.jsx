  ...
  return (
    <section id='contact-us' className='contact-us-container bg-light container mx-auto py-16 px-4 sm:px-8'>
      ...
      <div className='flex justify-center items-center'>
        ...
        >
          {() => (
            <Form className='bg-palette-hash bg-opacity-8 dark:bg-opacity-10 dark:bg-palette-lightDark dark:text-palette-text drop-shadow-xl shadow-lg p-2 rounded px-8 pt-6 pb-8 mb-4 w-[53%]'>
              <div className='mb-4'>
